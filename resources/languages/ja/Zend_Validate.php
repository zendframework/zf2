...
return array(
    ...
    // "The input is an empty string" - same message already appeared above.

    // Zend_I18n_Validator_Float
    // "Invalid type given. String, integer or float expected" - same message already appeared above.
    ...
    // "Invalid type given. String or integer expected" - same message already appeared above.
    ...
    // "Invalid type given. String expected" - same message already appeared above.
    ...
    // "An exception has been raised while validating the input" - same message already appeared above.

    // Zend_Validator_Csrf
    "The form submitted did not originate from the expected site" => "期待されるサイトからフォーム送信がなされていません",

    // Zend_Validator_Date
    "Invalid type given. String, integer, array or DateTime expected" => "無効な型が与えられています。文字列、数値型、配列もしくはDateTimeが期待",
    ...
    // "The input must contain only digits" - same message already appeared above.
    // "The input is an empty string" - same message already appeared above.
    // "Invalid type given. String, integer or float expected" - same message already appeared above.
    ...
    // "File '%value%' is not readable or does not exist" - same message already appeared above.

    // Zend_Validator_File_Exists
    "File '%value%' does not exist" => "ファイル '%value%' は存在しません",

    // Zend_Validator_File_Extension
    // "File '%value%' has a false extension" - same message already appeared above.
    // "File '%value%' is not readable or does not exist" - same message already appeared above.
    ...
    // "The mimetype of file '%value%' could not be detected" - same message already appeared above.
    // "File '%value%' is not readable or does not exist" - same message already appeared above.
    ...
    "The input is not an instance of '%className%'" => "入力値は '%className%' のインスタンスではありません",
    ...
    // "The input is not a valid step" - same message already appeared above.
