...
return array(
    ...
    "File '%value%' exceeds the defined ini size" => "Le fichier '%value%' dépasse la taille défini dans le fichier INI",
    ...
    "File exceeds the defined ini size" => "Le fichier dépasse la taille défini dans le fichier INI",
