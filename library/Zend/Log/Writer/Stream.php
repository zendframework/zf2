...
class Stream extends AbstractWriter
{
     ...
     * @throws \Zend\Log\Writer\Excpeiton\RuntimeException
     */
    public function __construct($streamOrUrl, $mode = \NULL)
    {
        ...
        if (is_resource($streamOrUrl)) {
            if (get_resource_type($streamOrUrl) != 'stream') {
                throw new Exception\InvalidArgumentException('Resource is not a stream');
            }

            if ($mode != 'a') {
                throw new Exception\InvalidArgumentException('Mode cannot be changed on existing streams');
            }
