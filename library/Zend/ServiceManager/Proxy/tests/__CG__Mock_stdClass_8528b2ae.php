 ...
 */
class Mock_stdClass_8528b2ae extends \Mock_stdClass_8528b2ae implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __wakeup()
    {
        ...
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function(Mock_stdClass_8528b2ae $proxy){
