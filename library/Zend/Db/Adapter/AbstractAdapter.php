...
abstract class AbstractAdapter
{
     ...
     * @var string
     */
    protected $_defaultProfilerClass = '\Zend\Db\Profiler';
     ...
     * @var integer
     */
    protected $_caseFolding = Db\Db::CASE_NATURAL;
    ...
    public function __construct($config)
    {
        ...
        if (array_key_exists(Db\Db::CASE_FOLDING, $options)) {
            ...
            switch ($case) {
                ...
                case Db\Db::CASE_UPPER:
                case Db\Db::CASE_NATURAL:
        ...
        if (array_key_exists(Db\Db::PROFILER, $this->_config)) {
            $profiler = $this->_config[Db\Db::PROFILER];
            unset($this->_config[Db\Db::PROFILER]);
        }
...
//            }
    ...
    public function fetchAssoc($sql, $bind = array())
    {
        $stmt = $this->query($sql, $bind);
        $data = array();
        while ($row = $stmt->fetch(Db\Db::FETCH_ASSOC)) {
    ...
    public function fetchPairs($sql, $bind = array())
    {
        $stmt = $this->query($sql, $bind);
        $data = array();
        while ($row = $stmt->fetch(Db\Db::FETCH_NUM)) {
            $data[$row[0]] = $row[1];
        }
        return $data;
    }
        ...
        if ($type !== null && array_key_exists($type = strtoupper($type), $this->_numericDataTypes)) {
            ...
            switch ($this->_numericDataTypes[$type]) {
                case Db\Db::INT_TYPE: // 32-bit integer
                    ...
                    break;
                case Db\Db::BIGINT_TYPE: // 64-bit integer
                    ...
                    break;
                case Db\Db::FLOAT_TYPE: // float or decimal
     ...
     * the adapter.
     *
     * @param string|array|\Zend\Db\Expr $ident The identifier.
