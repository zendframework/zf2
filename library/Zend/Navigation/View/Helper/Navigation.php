...
use Zend\Navigation\View\Helper\AbstractHelper as AbstractNavigationHelper;
use Zend\Navigation\View\Helper\PluginManager;
use Zend\Navigation\View\Helper\HelperInterface as NavigationHelper;
...
class Navigation extends AbstractNavigationHelper
{
     ...
     * @var string
     */
    const NS = 'Zend\Navigation\View\Helper';
