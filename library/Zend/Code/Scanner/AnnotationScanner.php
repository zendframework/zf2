...
class AnnotationScanner extends AnnotationCollection implements Scanner
{
     ...
     *
     */
    public function __construct(AnnotationManager $annotationManager, $docComment, NameInformation $nameInformation = null)
    {
    ...
    protected function tokenize()
    {
        ...
        TOKENIZER_TOP:
            ...
            if ($MACRO_HAS_CONTEXT($CONTEXT_CONTENT) && $MACRO_HAS_CONTEXT($CONTEXT_ASTERISK)) {
                ...
                $annotationParenCount += substr_count($currentWord, '(');
                $annotationParenCount -= substr_count($currentWord, ')');
