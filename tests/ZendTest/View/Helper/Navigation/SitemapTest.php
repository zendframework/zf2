...
class SitemapTest extends AbstractTest
{
    ...
    public function testRenderSuppliedContainerWithoutInterfering()
    {
        ...
        $actual = array(
            'registered'       => _normalizeEOL($this->_helper->render()),
            'supplied'         => _normalizeEOL($this->_helper->render($this->_nav2)),
            'registered_again' => _normalizeEOL($this->_helper->render())
        );
    ...
    public function testUseAclRoles()
    {
        ...
        $this->assertEquals($expected, _normalizeEOL($this->_helper->render()));
    }
    ...
    public function testDropXmlDeclaration()
    {
        ...
        $this->assertEquals($expected, _normalizeEOL($this->_helper->render($this->_nav2)));
    }
