...
use Zend\InputFilter\ValidationGroup\RegexFilterIterator;

class RegexFilterIteratorTest extends TestCase
{
    public function testStripOnlyValuesNotMatchingRegex()
    {
        ...
        $arrayFilterIterator = new RegexFilterIterator($inputCollection, '/bar/');
        $count               = 0;
