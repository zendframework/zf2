...
use Zend\Form\View\Helper\FormHidden as FormHiddenHelper;
 ...
 * @subpackage UnitTest
 */
class FormHiddenTest extends CommonTestCase
{
    ...
    public function testGeneratesHiddenInputTagWithElement()
    {
    ...
    public function testGeneratesHiddenInputTagRegardlessOfElementType()
    {
        $element = new Element('foo');
    ...
    public function validAttributes()
    {
        return array(
            ...
            array('autofocus', 'assertNotContains'),
