...
class SyslogTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('Zend\Log\Writer\Exception\InvalidArgumentException', 'Invalid log facility provided');
        $writer = new SyslogWriter();
    ...
    public function testThrowExceptionIfFacilityInvalidInWindows()
    {
        ...
        $this->setExpectedException('Zend\Log\Writer\Exception\InvalidArgumentException', 'Only LOG_USER is a valid');
        $writer = new SyslogWriter();
