...
class DbTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('Zend\Log\Writer\Exception\InvalidArgumentException', 'does not support formatting');
    ...
    public function testShutdownRemovesReferenceToDatabaseInstance()
    {
        ...
        $this->setExpectedException('Zend\Log\Writer\Exception\RuntimeException', 'Database adapter is null');
