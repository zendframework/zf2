...
use Zend\Dojo\Form\Decorator\DijitForm as DijitFormDecorator;
 ...
 */
class DijitFormTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->decorator = new DijitFormDecorator();
